...
from external.Infinity.infinity.models.infinity import Infinity
from external.Infinity.infinity.models.basic import *
...
def load_visual_tokenizer(args):
    ...
    if args.vae_type in [14,16,18,20,24,32,64]:
        from external.Infinity.infinity.models.bsq_vae.vae import vae_model
